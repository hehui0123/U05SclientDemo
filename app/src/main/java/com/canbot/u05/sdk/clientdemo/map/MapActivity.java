...
public class MapActivity extends Activity {
         ...
         * 执行去某个点任务
         */
        public void gotoOneTask(String taskName) {
                if (iMapAidlInterface != null) {
                        try {
                                iMapAidlInterface.sendMapMsg(MapMsgType.MAP_SDK_TYPE_GET_MAP_GO_TASK, taskName);
                        }
                        catch (RemoteException e) {
                                e.printStackTrace();
                        }
         ...
         * 获取某个任务所有的点
         */
        public void getOneTaskAllPoint(String taskName) {
                if (iMapAidlInterface != null) {
                        try {
                                iMapAidlInterface.sendMapMsg(MapMsgType.MAP_SDK_TYPE_GET_MAP_GO_ONE_TASK_POINT, taskName);
                        }
                        catch (RemoteException e) {
                                e.printStackTrace();
                        }
        ...
        public void getOneTaskPoint(View view){
                getOneTaskAllPoint("");
        }
